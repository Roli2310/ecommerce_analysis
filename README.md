...
* **EDA & Data Sanitization:** Ingested raw source data (`E-commerce Customer Behavior - Sheet1.csv`), handled missing values in the `satisfaction_level` column, and standardized column headers to uniform.
